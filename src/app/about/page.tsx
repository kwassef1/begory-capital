                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div className="max-w-2xl mx-auto flex flex-col gap-5 items-center text-center">
                        ...
                        <h1 className="text-3xl sm:text-4xl font-semibold text-foreground leading-snug">
                            Built for real estate investors, by people who
                            understand the deal.
                        </h1>
                        <p className="text-base text-muted-foreground">
                            Begory Capital was founded to fill the gap between
                            slow institutional lenders and unreliable hard
                            money. We built a lending business around what real
                            estate investors actually need — fast decisions,
                            honest communication, and capital that closes on
                            time.
                        </p>
                    </div>
                </section>
                        ...
                        left={
                            <div className="flex flex-col gap-4">
                                ...
                                <h2 className="text-2xl font-semibold text-foreground leading-snug">
                                    We started lending because we lived on the
                                    borrower side of the table.
                                </h2>
                                <p className="text-sm text-muted-foreground">
                                    Before Begory Capital, our team spent years
                                    inside the real estate industry — acquiring
                                    properties, managing renovations, and
                                    navigating lease-ups. We knew firsthand how
                                    much a lender&apos;s decision-making speed
                                    and communication could make or break a
                                    deal.
                                </p>
                                <p className="text-sm text-muted-foreground">
                                    We built Begory Capital to be the lender we
                                    always wished existed: one that understood
                                    contracts, appraisals, and construction
                                    draws — and that treated every file like its
                                    own investment.
                                </p>
                                <p className="text-sm text-muted-foreground">
                        ...
                        right={
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-400">
                                    Every deal is evaluated on the numbers —
                                    purchase price, rehab budget, after-repair
                                    value, and exit strategy. This discipline is
                                    what lets us move fast and still protect
                                    both the borrower and ourselves.
                                </p>
                    ...
                    >
                        <div className="flex flex-col gap-1.5">
                            ...
                            <h2 className="text-xl font-semibold text-gray-100">
                                At Begory, we work with a tight network of
                                professionals.
                            </h2>
                            <p className="text-sm text-gray-400">
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-400 max-w-md">
                            Tell us about your deal and we&apos;ll respond with
                            structure options, estimated terms, and next steps.
                        </p>
