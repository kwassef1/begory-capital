...
export const metadata: Metadata = {
    ...
    description:
        "Invest capital with Begory Capital and earn consistent returns secured by first-lien real estate loans.",
    openGraph: {
                            ...
                            left={
                                <div>
                                    ...
                                    <p className="mt-3 text-sm text-gray-400">
                                        This disciplined approach is what allows
                                        us to protect investor capital and
                                        deliver consistent returns. Every deal
                                        is evaluated on the numbers, not on
                                        hope.
                                    </p>
                                </div>
                            }
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-400 max-w-md">
                            Share your details and we&apos;ll send over investor
                            materials and schedule a call with our team.
                        </p>
                        <Button variant="primary" size="lg" asChild>
                            <SmoothScrollLink href="/contact#investor-form">
                                Request Investor Information
